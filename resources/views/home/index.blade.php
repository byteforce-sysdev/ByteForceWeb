...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-153550735-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'UA-153550735-1');
    </script>
    <meta charset="utf-8" />
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/icon/favicon-96x96.png') }}">
